...
export const SALE_SOURCE_PAGE_CACHE_KIND = 'kr-molit-sale-source-page-v1' as const;
export const SALE_SOURCE_MANIFEST_CACHE_KIND = 'kr-molit-sale-source-manifest-v1' as const;
