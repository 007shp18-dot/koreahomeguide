...
export default function Page() { return <SingaporePage locale="ko" currentHref="/ko/sg/singapore/shortlist/" unframed><BudgetSearch locale="ko" market="singapore" /></SingaporePage>; }
