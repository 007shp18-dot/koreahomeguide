...
export const metadata=indexableMetadata({path:'/ko/jp/tokyo/',title:'Tokyo property prices and neighbourhoods | SignedPrice',description:'Official Tokyo housing transactions by ward and neighbourhood.'});
