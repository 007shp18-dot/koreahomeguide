...
export const metadata = indexableMetadata({ path: '/ko/prices/', title: '서울·싱가포르·두바이 실거래가 | signedprice', description: '도시별 공개 거래 자료를 검색하고 지역·건물·단지의 가격과 자료 범위를 비교하세요.', languageAlternates: { en: '/prices/', ko: '/ko/prices/' }, locale: 'ko_KR', imagePath: '/og/ko/' });
const markets = [
...
export default async function Page({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <KoreanSiteFrame href="/ko/prices/"><main className={styles.page}>
    <ResearchPageHeading title="실거래가" description="도시를 선택하고 공개된 계약 자료로 관심 지역과 주택의 가격을 비교하세요." />
