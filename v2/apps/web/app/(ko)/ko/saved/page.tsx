...
export default function Page() {return <ToolsShell locale="ko" href="/ko/saved/"><ResearchPageHeading title="관심 목록" description="저장한 건물로 돌아가 최신 거래를 확인하세요. 서울·싱가포르·두바이·도쿄를 지원합니다."/><SavedCities locale="ko" initiallyOpen /></ToolsShell>;}
