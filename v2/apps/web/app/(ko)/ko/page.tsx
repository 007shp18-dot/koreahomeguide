...
export const metadata = indexableMetadata({ path: '/ko/', title: '서울·싱가포르·두바이 부동산 실거래 비교 | SignedPrice', description: '서울·싱가포르·두바이의 실거래가를 살펴보고, 관심 있는 집의 가격을 비교해 보세요.', locale: 'ko_KR', languageAlternates: { en: '/', ko: '/ko/' } });
