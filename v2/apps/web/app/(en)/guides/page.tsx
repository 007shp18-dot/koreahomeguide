...
export default async function GuidesPage({ searchParams }: { searchParams: Promise<{ market?: string; q?: string }> }) {
  ...
  return <EditorialGrowthPublicFrame locale="en" surface="content" activeSection="guides" currentHref={`/guides/?market=${guideMarket}`}><EditorialGuides market={guideMarket} query={typeof q === 'string' ? q.slice(0, 120) : ''} /></EditorialGrowthPublicFrame>;
}
