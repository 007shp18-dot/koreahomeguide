  ...
  return <div id="top">
    ...
    <main className={styles.policyPage}>
      ...
      <section id="editorial" className={styles.policyGrid} aria-label="How SignedPrice reports are made">
        ...
        <article><h2>How do we use AI?</h2><p>We use AI-assisted drafting, editing and translation alongside software that organizes transaction records. AI output is not a source for property facts. The original publication, calculation method and reporting period are the basis for factual claims. SignedPrice remains responsible for published content and corrections.</p></article>
