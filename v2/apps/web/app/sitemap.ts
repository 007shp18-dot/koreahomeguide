...
const localizedPairs: readonly LocalizedPair[] = Object.freeze([
  ...
  Object.freeze({ en: '/about/', ko: '/ko/about/' }),
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  entries.push(...JOURNEY_ARTICLE_ROUTES.flatMap(({ city, id }) => (['en', 'ko'] as const).map(locale => sitemapEntry(journeyArticleHref(city, id, locale), new Date('2026-09-09')))));
