import { OFFICIAL_PROPERTY_SOURCES as S } from '../insights/official-property-sources';
import type { EditorialArticle } from '../insights/editorial-content';

// Frozen typography-review input. Not used by public article routes or discovery.
// Public editorial revisions must not silently change the approved layout baseline.
export const TYPOGRAPHY_REVIEW_ARTICLES: readonly EditorialArticle[] = Object.freeze([
  Object.freeze({
