...
export function resolveSeoulEntityCheckContext(query:Readonly<Record<string,string|string[]|undefined>>,input:Readonly<{locale:'en'|'ko';districtSlug:string;buildingId:string|null;buildingName:string|null}>) {
