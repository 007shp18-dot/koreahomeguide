    ...
    markets: [
      {
        ...
        summary: zh ? '查看已申报的买卖、全租与月租依据。' : 'Read reported sale, jeonse and monthly-rent evidence.',
      ...
      },
      {
        ...
        summary: zh ? '分开查看私人住宅与 HDB 公共住宅。' : 'Compare private residential projects and HDB without mixing sectors.',
      ...
      },
      {
        ...
        summary: zh ? '先了解市场和项目背景，再判断投资机会。' : 'Start with market and project context before evaluating an opportunity.',
