...
const internationalVisuals: readonly HomeMarketVisual[] = Object.freeze([
  { id: 'sg-the-sail', name: 'The Sail @ Marina Bay', market: 'Singapore', countryCode: 'SG', location: 'Marina Bay · Downtown Core', provider: 'google', latitude: 1.2753, longitude: 103.8517, observationLabel: 'Singapore market context', periodLabel: 'Nearby street view · not a listing photo', href: '/sg/singapore/explore/', mapHref: 'https://www.google.com/maps/search/?api=1&query=The+Sail+at+Marina+Bay+Singapore' },
