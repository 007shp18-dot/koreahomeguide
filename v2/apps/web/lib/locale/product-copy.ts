...
const koreanContractCheckCopy = Object.freeze({
  ...
  range: {
    observed: '자료 범위 안',
    held: '자료 범위를 벗어나 가장 가까운 구간의 전환율을 적용합니다.',
  },
  empty: {
    invalidTitle: '표시된 계약 조건을 확인하세요.',
    blankTitle: '비교할 두 집의 보증금과 월세를 입력하세요.',
    ...
    blankAction: 'A와 B의 조건을 입력하면 바로 비교할 수 있습니다.',
  },
  result: {
    heading: '결과',
    ...
    principalBoundary: '반환되는 보증금 원금 자체를 월세로 더하지 않고, 전체 보증금의 기회비용만 거래 자료로 계산한 연 전환율로 환산합니다.',
  },
  hero: {
    eyebrow: '서울 · 계약 조건 비교',
    headingLead: '어느 계약 조건의',
    headingTail: '월 비용이 더 낮을까요?',
    description: '두 집의 보증금과 월세를 월 비용으로 환산해 비교합니다.',
  },
  mode: {
    ariaLabel: '비교 방식',
    budget: '내 예산',
    ...
    compare: '두 계약 비교',
    compareDescription: '입력하면 바로 계산됩니다',
  },
  housingType: '주택 유형',
  apartment: '아파트',
  officetel: '오피스텔',
  ...
  moreEvidence: '다른 실거래가 보기',
  localDistribution: '관심 매물의 보증금·월세 비교',
  explore: '서울 구별 실거래가 보기',
  footer: [
  ...
  unavailable: {
    eyebrow: '서울 · 계약 조건 비교',
    title: '전환율 자료를 불러오지 못했습니다.',
    actionLead: '서울 실거래가에서 비슷한 계약을 찾아보세요.',
  ...
  curve: {
    ...
    heldNotice: '자료 범위를 벗어나 가장 가까운 구간의 전환율을 적용합니다.',
  },
} as const satisfies ContractCheckCopy);
...
const englishPublicMarketCopy = Object.freeze({
  ...
  area: {
    ...
    coverageHeading: 'Available coverage',
    ...
    buildingArtifactMissing: 'Building records are unavailable.',
    sourceCandidatesMissing: 'Candidate building counts are unavailable in this dataset.',
    ...
    buildingEvidence: 'building transactions',
    ...
    buildingArtifactReason: 'District transactions remain available while building records are unavailable.',
  ...
  rankings: {
    ...
    descriptionLead: 'Four evidence views from MOLIT reported zero-rent jeonse contracts, the fixed 45–55㎡ size band and declared period',
...
const koreanPublicMarketCopy = Object.freeze({
  ...
  area: {
    heroEyebrow: '서울 · 구별 전세 실거래가',
    heroHeading: '서울 구별 전세보증금을 같은 기준으로 비교합니다.',
    heroDescription: '같은 기간의 45–55㎡ 전세 거래를 비교합니다. 구를 선택해 가격과 거래 건수를 확인하세요.',
    rankingsLink: '구별 실거래가 비교',
    coverageEyebrow: '데이터 범위',
    coverageHeading: '어디까지 확인할 수 있나요?',
    districtsPublished: '가격을 제공하는 구',
    buildingsPublished: '가격을 제공하는 건물',
    observedBuildings: '자료에 포함된 건물',
    transactionCoveredBuildings: '거래 내역이 있는 건물',
    priceReadyBuildings: '가격 확인 가능',
    priceEvidenceUnavailable: '가격 자료 없음',
    observedPeriod: '집계 기간',
    jeonseObservations: '전세 거래',
    monthlyObservations: '월세 거래',
    openBuilding: '건물 보기',
    ...
    retainedBuildingsBelowMinimum: '개 건물은 거래가 적어 가격을 표시하지 않습니다.',
    buildingArtifactMissing: '건물별 자료를 불러오지 못했습니다.',
    sourceCandidatesMissing: '원자료에 포함된 전체 건물 수는 확인할 수 없습니다.',
    mapEyebrow: '01 / 구 지도',
    mapHeading: '구별 전세보증금 중앙값',
    mapTitle: '서울 구별 전세보증금 지도',
    mapDescription: '중앙값을 다섯 단계로 구분합니다. 빗금은 미게시 구이며, 옆 탐색 목록에서 키보드로 구를 선택하고 정확한 값을 확인할 수 있습니다.',
    mapLegend: '구별 전세보증금 중앙값',
    districtCount: '개 구',
    notPublished: '미게시',
    fewerThan: '표본',
    contracts: '건 미만',
    ...
    buildingEvidence: '건물별 거래 내역',
    noPublishedBuildings: '아직 5건 게시 기준을 통과한 건물이 없습니다.',
    noSyntheticBuildings: '거래가 충분히 쌓이면 가격을 확인할 수 있습니다.',
    buildingArtifactReason: '구별 가격은 계속 확인할 수 있습니다.',
    neighborhoodFilter: '동 필터',
    all: '전체',
    showMore: '건물 10개 더 보기',
    completeTableEyebrow: '03 / 전체 표',
    completeTableHeading: '서울 25개 구',
    tableCaption: '서울 구별 전세 거래 비교 · 법정동 코드순',
    district: '구',
    median: '중앙값',
    sample: '표본',
    evidence: '근거',
    ...
    renewal: '갱신',
    unclassified: '미분류',
    fullBuildingEvidence: '건물별 거래 내역 보기',
    unavailableEyebrow: '서울 · 구별 실거래가',
    unavailableReason: '이 구의 거래 자료를 불러오지 못했습니다.',
    unavailableAction: '자료가 준비되면 지도에서 가격을 확인할 수 있습니다.',
    unavailableActionLink: '서울 실거래가로 돌아가기',
  },
  summary: {
    seoul: '서울',
    groups: { all: '전체 계약', new: '신규 계약', renewal: '갱신 계약' },
    median: '전세보증금 중앙값',
    evidencePeriodSuffix: '신고된 계약의 집계 기간을 기준으로 합니다.',
    middleHalf: '중간 50% 구간',
    fullRange: '전체 범위',
    spread: '가격 차이 살펴보기',
    recentChange: '최근 변화',
    ...
    withheldAction: '다른 계약 유형을 선택하거나 데이터 갱신 후 다시 확인하세요.',
    snapshotReason: '현재 자료는 전체 계약 기준으로만 확인할 수 있습니다.',
    snapshotAction: '전체 계약을 선택해 확인하세요.',
    ...
    comparisonAria: '계약 유형별 가격 비교',
    sampleUnavailable: '표본 확인 불가',
    snapshotUnavailable: '자료 없음',
    allLowerThanNew: '이 자료에서 전체 계약 중앙값이 신규 계약 중앙값보다 낮습니다.',
    reportedPeriod: '계약 집계 기간',
    openEvidence: '거래 내역 보기',
    selectorAria: '계약 유형별 거래 내역',
    splitUnavailable: '이 자료에는 신규·갱신 구분이 없습니다.',
  },
  source: {
    eyebrow: '출처와 한계',
    heading: '출처와 집계 기준을 확인하세요.',
    disclosureAria: '데이터 안내',
    ...
    unavailableTitle: '자료 출처를 불러오지 못했습니다.',
