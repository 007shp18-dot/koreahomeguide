...
export const BUDGET_GUIDE_SLUGS = [
  ...
  'seoul-same-budget-property-comparison',
  'singapore-same-budget-property-comparison',
  'dubai-same-budget-property-comparison',
  'tokyo-same-budget-property-comparison',
] as const;
