...
export const ENGLISH_PORTFOLIO = Object.freeze([
  ...
  portfolioRecord({
    ...
    title: 'Seoul apartment sale prices: how to compare August 2026 transactions', deck: 'Read 22,850 installed reported-sale records by completed period, district, building and size before describing movement.',
  ...
  portfolioRecord({
    ...
    title: 'Seoul jeonse deposits: comparing August 2026 contracts', deck: 'The current rent release contains 49,129 eligible contracts across rental structures; jeonse should be filtered before comparison.',
  ...
  portfolioRecord({
    ...
    title: 'How much does it cost to rent in Seoul? Include the deposit', deck: 'A lower monthly payment can conceal a larger deposit, so every market comparison needs one disclosed conversion basis.',
  ...
  portfolioRecord({
    ...
    title: 'Jeonse vs monthly rent: compare the cost of two Korean homes', deck: 'Separate recurring rent, management fees and the chosen cost of tied-up deposit capital before comparing two Korean rental offers.',
