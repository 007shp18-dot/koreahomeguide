...
export const ENGLISH_PORTFOLIO = Object.freeze([
  ...
  portfolioRecord({
    ...
    title: 'Seoul sale data, August 2026: coverage and comparison limits', deck: 'Read 22,850 installed reported-sale records by completed period, district, building and size before describing movement.',
    question: 'What does the August 2026 Seoul sale release cover, and how should it be compared?',
  ...
  portfolioRecord({
    ...
    title: 'Seoul jeonse data, August 2026: which contracts to compare', deck: 'The current rent release contains 49,129 eligible contracts across rental structures; jeonse should be filtered before comparison.',
    question: 'Which contracts belong in a comparison of Seoul jeonse deposits?',
  ...
  portfolioRecord({
    ...
    title: 'Seoul monthly-rent data: why the deposit changes the comparison', deck: 'A lower monthly payment can conceal a larger deposit, so every market comparison needs one disclosed conversion basis.',
    question: 'How should deposit and monthly rent be compared in reported Seoul contracts?',
  ...
  portfolioRecord({
    ...
    title: 'Singapore condo prices in Q2 2026: what the URA index shows', deck: 'URA reported a 0.5% quarterly increase in the overall private residential price index, while regional movements differed.',
  ...
  portfolioRecord({
    ...
    title: 'Seoul rental deposits by district: what a median price hides', deck: 'District medians are entry points; spreads, property mix and building-level evidence explain why the same middle number can mask different choices.',
  ...
  portfolioRecord({
    ...
    title: 'Seoul rent: do new tenants and renewing tenants pay the same?', deck: 'One published cohort shows how new and renewed contracts can occupy different centres even inside the same building and size band.',
    question: 'How do new and renewal deposits differ in one Dobong apartment cohort?',
  ...
  portfolioRecord({
    ...
    title: 'Korean rental costs: a worked example of rent, fees and deposit', deck: 'An illustrative cost breakdown shows how rent, management fees and deposit capital contribute to one monthly comparison.',
  ...
  portfolioRecord({
    ...
    title: 'Singapore condo prices: CCR vs RCR vs OCR compared', deck: 'Published private-project median PSF differs by region, but project mix, tenure, sale type and unit size remain essential context.',
  ...
  portfolioRecord({
    ...
    points: [
      ['The headline number', 'A five-year project-level screen places the median of project medians at roughly S$1,680 psf, but that summary is not a current apartment price.'],
      ['The budget screen', 'Eighteen projects cleared the 80–100 square metre, S$1.5 million resale screen in H1 2026; 135 of 138 included resales were at or below the ceiling.'],
      ['The buyer profile', 'A foreign buyer subject to the standard 60% ABSD rate adds S$900,000 to a S$1.5 million purchase before BSD and other costs.'],
    ], boundary: 'URA caveats are reported transaction evidence, not live listings, appraisals or forecasts. Project, tenure, size and sale type remain essential context.',
  ...
  portfolioRecord({
    ...
    points: [
      ['The two July numbers', 'The 23-ward contracted-price median reached ¥1.358 million per square metre, up 2.7% year on year, while contracts fell 17.2%.'],
      ['Central divergence', 'Chiyoda, Chuo and Minato contracted prices fell 5.9% year on year as active listings rose 50.5%.'],
      ['The closing number', 'A listing is an opening position. REINS and MLIT contracted-price records show the number that actually closed.'],
    ], boundary: 'REINS and MLIT series have different methods; listing prices are not completed transactions, and SignedPrice does not forecast or recommend purchases.',
    sources: [RESEARCH_SOURCES.reinsTokyo, RESEARCH_SOURCES.mlitLibrary], evidenceReleaseIds: [RELEASES.tokyoReinsJuly, RELEASES.tokyoMlitJuly], relatedHref: '/jp/tokyo/explore/', publishedAt: '2026-09-11T00:00:00.000Z',
  }),

].map(enrichEnglishRecord));
