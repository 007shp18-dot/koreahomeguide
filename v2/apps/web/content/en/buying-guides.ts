...
export const BUYING_GUIDES: readonly EditorialPortfolioRecord[] = [
  {
    ...
    "deck": "Explore nine historical project examples across three budgets, compare observed sizes and selected purchase costs, and check ownership conditions before shortlisting.",
