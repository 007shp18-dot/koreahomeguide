...
export const AFFORDABLE_RESALE_STORIES: readonly EditorialPortfolioRecord[] = [
  {
    ...
    "revisionNote": "Revised after first publication to prioritize July–August transactions, require an August observation and distinguish a recent-sale shortlist from active inventory.",
