...
const copy: Readonly<Record<string, readonly [string, string, string]>> = {
  'korea-rental-deposit-protection-status': ['한국 임대차보증금 보호: 현재 확인해야 할 사항', '주택 인도, 전입신고, 확정일자와 보증 가입을 확인하는 실무 기록입니다. 각 절차의 목적이 달라 별도로 살펴봅니다.', '현재 어떤 보증금 보호 규정이 적용되며, 언제부터 시행됐을까요?'],
  ...
  'singapore-absd-policy-status': ['싱가포르 ABSD: 세액 계산 전에 매수자 조건부터 확인하기', '추가 매수자 인지세는 매수자와 부동산 조건에 따라 달라집니다. 세율과 감면 여부는 IRAS의 규정이 기준입니다.', '매수자 조건에 따라 어떤 추가 매수자 인지세 규정이 적용될까요?'],
...
const bodies: Readonly<Record<string, string>> = {
  'korea-rental-deposit-protection-status': `## 적용 조건\n\n보호 여부는 정확한 주택, 현재 등기, 주택 인도와 임차인에게 가능한 신고 절차에 따라 달라집니다. 확정일자와 보증 가입은 서로 대체할 수 없는 별개의 확인 사항입니다.\n\n## 확인할 사항\n\n돈을 보내기 전에 등기상 부동산과 소유자를 대조한 다음, 임차인의 체류 자격 등에 맞는 절차의 순서와 자격 요건을 담당 공공기관이나 보증기관에 확인하세요.\n\n## 달라진 점\n\n이 최초 공개 기록은 포괄적인 보증금 안전성 표현을 출처에 기반한 점검표와 확인 시점이 명시된 상태 기록으로 바꿉니다.\n\n## 근거의 한계\n\n이 기록은 확인 순서를 설명하며, 법적 우선순위, 보증 가입 자격이나 특정 보증금의 안전성을 판단하지 않습니다.`,
  ...
  'singapore-absd-policy-status': `## 매수자 분류\n\n국적이나 거주 자격, 법인 여부와 보유 주거용 부동산 수에 따라 ABSD 적용이 달라질 수 있습니다.\n\n## 취득 내용 분류\n\n취득 지분, 취득일, 취득 방식과 적용 가능한 감면 조건도 중요합니다.\n\n## 최신 세율표 사용\n\nIRAS의 현행 세율과 정의를 확인한 뒤 계산하고, 사용한 페이지와 확인일을 거래 자료에 보관하세요.\n\n## 근거의 한계\n\nSignedPrice는 최종 인지세를 계산하거나 감면 자격을 판단하지 않습니다.`,
