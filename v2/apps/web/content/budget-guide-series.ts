...
export const BUDGET_GUIDE_SERIES = [
  ...
  { city: 'tokyo', slug: 'tokyo-apartment-buying-budget-guide', budgets: { en: 'JPY 30M · 50M · 100M', ko: '3천만 · 5천만 · 1억 엔', 'zh-CN': '3,000万 · 5,000万 · 1亿日元' }, period: { en: '2026 Q1 · five wards per budget', ko: '2026년 1분기 · 예산별 다섯 구', 'zh-CN': '2026年第1季度 · 每档预算五个区' } },
] as const;
