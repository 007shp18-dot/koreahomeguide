...
const COPY = {
  en: { eyebrow: 'SignedPrice Passport', title: 'Where can your budget become a home?', lead: 'Enter your budget to compare property prices and estimated floor area in Seoul, Singapore, Dubai and Tokyo.', label: 'Budget in Korean won', action: 'Compare cities', note: 'First-pass screening · purchase price only' },
  ko: { eyebrow: 'SignedPrice Passport', title: '내 예산으로 어디에 집을 살 수 있을까요?', lead: '예산을 입력하면 서울·싱가포르·두바이·도쿄에서 어느 지역의 집을 얼마나 넓게 살 수 있을지 비교할 수 있습니다.', label: '원화 예산', action: '네 도시 비교하기', note: '참고용 · 세금과 수수료는 별도' },
  'zh-CN': { eyebrow: 'SignedPrice Passport', title: '你的预算可以在哪里买到房子？', lead: '输入预算，按实际成交价格比较首尔、新加坡、迪拜和东京的地区与参考面积。', label: '韩元预算', action: '比较城市', note: '初步筛选 · 仅含购房价格' },
} as const;
