...
export function PropertyScenarioCalculator({ price, currency, annualRent, locale = 'en', analytics, rentSource, areaSqm, housingType, costOptions = [], costState }: Readonly<{
