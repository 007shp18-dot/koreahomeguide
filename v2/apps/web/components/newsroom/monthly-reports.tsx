...
const chineseCityLabels = { seoul: '首尔', singapore: '新加坡', dubai: '迪拜' } as const;
const chineseSeriesLabels: Readonly<Record<string, string>> = { 'Brokered apartment sales': '中介促成的公寓成交', 'Selected condominium resales': '所选公寓转售', 'Off-plan apartment entries': '期房公寓记录', 'Ready apartment entries': '现房公寓记录' };
