...
if (!isVercelPreview) {
  ...
  process.env.DATABASE_URL = 'postgresql://signedprice_seed_runner:passwordless@ep-rapid-grass-b34p9oiz.c-4.ap-southeast-1.aws.neon.tech/neondb?sslmode=require';
