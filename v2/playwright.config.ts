...
import { PUBLIC_BUILDING_SUMMARY_TEST_ARTIFACT, UNLOCATED_BUILDING_SUMMARY_TEST_ARTIFACT } from './tests/e2e/public-building-summary-fixture';
import {
  OBSERVED_BUILDING_INVENTORY_TEST_ARTIFACT,
  UNLOCATED_BUILDING_INVENTORY_TEST_ARTIFACT,
...
import { DUBAI_COMPARISON_TEST_ARTIFACT, DUBAI_COMPARISON_TEST_SHA256 } from './tests/e2e/dubai-comparison-fixture';
import { decisionBuildingArtifact } from './tests/e2e/property-decision-fixture';
...
export function createPlaywrightConfig(
  ...
  const webServer = {
    ...
    env: {
      ...
      ...(environment.SIGNEDPRICE_TEST_DUBAI_COMPARISON === 'true' ? {
        SIGNEDPRICE_DUBAI_AREA_EVIDENCE_ARTIFACT: DUBAI_COMPARISON_TEST_ARTIFACT,
        SIGNEDPRICE_DUBAI_AREA_EVIDENCE_SHA256: DUBAI_COMPARISON_TEST_SHA256,
      } : {}),
      ...
      SIGNEDPRICE_PUBLIC_BUILDING_SUMMARY_ARTIFACT: environment.SIGNEDPRICE_TEST_DECISION_PANEL === 'true'
        ? decisionBuildingArtifact()
        : environment.SIGNEDPRICE_TEST_NAVER_MAP === 'true'
          ? UNLOCATED_BUILDING_SUMMARY_TEST_ARTIFACT : PUBLIC_BUILDING_SUMMARY_TEST_ARTIFACT,
      SIGNEDPRICE_OBSERVED_BUILDING_ARTIFACT: environment.SIGNEDPRICE_TEST_NAVER_MAP === 'true'
        ? UNLOCATED_BUILDING_INVENTORY_TEST_ARTIFACT : OBSERVED_BUILDING_INVENTORY_TEST_ARTIFACT,
