...
function trackBase(mapped,data){return{language,source_page:acquisitionContext.sourcePage||location.pathname,tool_page:location.pathname,district_code:area.value,property_type:mapped.officialType,rating:data&&data.rating||'',confidence:data&&data.confidence||'',sufficient:data?data.rating!=='insufficient':undefined};}
